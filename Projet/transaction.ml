...
(* trnasformer une transaction en string pour pouvoir la signer *)
...
(* creer et signer une transaction *)
...
(* verifier si une transaction est correctement signee *)
let is_valid tr =
...
(* retourner l'entete d'un string,
utilise pour visualiser les longues adresses RSA sans saturer le terminal *)
let header addr =
